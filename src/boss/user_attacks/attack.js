...
import { attack_event_callback } from '#src/boss/user_attacks/events.js'
 ...
 * @param {CallableFunction | number | null} update_current
 * @returns {number}
 */
...
export function core_make_attack_context( boss , user , channel , primary = {} ) {
	...
	const attackContext = {
		...
		damageMultiplayer: 1 ,
		eventsCount: Math.floor( boss.level ** 0.5 ) + randomWith( -1 , 1 ) ,
		listOfEvents: [] ,
		message: null ,
		addableDamage: 0 ,
	}
