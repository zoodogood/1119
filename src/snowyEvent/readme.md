...
- Чтобы досрочно вызвать событие установите singletonBotData().snowyEvent.now в значение `true`
- Не стесняйся!

```
!eval m'singletonBotData().snowyEvent ||= {};
m'singletonBotData().snowyEvent.now = true
```
