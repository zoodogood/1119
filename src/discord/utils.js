 ...
 */
import client from '../bot/client/singleton.js'
...
export function resolve_message_in_answer( answer ) {
	// return id
	return answer.content.match( /\d{17,21}/g ).at( -1 ) ?? answer.reference.messageId
}
 ...
 *
 * @param {User} user
 * @returns {Guild[]} guilds
 */
export function guildsOfUser( user ) {
