...
> `yarn build` ИЛИ `yarn docker`  
Чтобы произвести инициализацию вне контейнера: yarn build & yarn start или концепция докер контейнеров: yarn docker чтобы собрать и запустить образ в докере
