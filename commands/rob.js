    ...
    if (react || monsterHelps || detective) {
      ...
      if (react) {
        ...
        if (hurt){
          ...
          react = await hurtMessage.awaitReact({user: memb, removeType: "none", time: 60000}, "😇", "😈");
          if (react === "😇"){
