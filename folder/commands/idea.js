...
class Command {
  async onChatInput(msg, interaction) {
    ...
    if (!heAccpet)
      return msg.author.msg({
        title:
          "Ваша идея не была отправлена так как вы не подтвердили отправку",
        description: "Текст идеи:\n" + interaction.params,
        color: "#ff0000",
      });

    const channel = client.guilds.cache
      .get("752898200993660959")
      .channels.cache.get("753587805195862058");
  ...
  options = {
    ...
    allias: "идея innovation новвоведение ідея",
    allowDM: true,
    expectParams: true,
    cooldown: 1_200_000,
    cooldownTry: 3,
