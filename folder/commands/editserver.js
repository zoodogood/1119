    ...
    while (true) {
      ...
      switch (react) {
        ...
        case "🚸":
          ...
          answer = await bot_msg.awaitReact({user: msg.author, removeType: "all"}, "685057435161198594", "763804850508136478");
          bot_msg.delete();
        ...
        case "🏝️":
          ...
          let channel = await bot_msg.awaitReact({user: msg.author, removeType: "all"}, "🔥", "📒", "👌");
